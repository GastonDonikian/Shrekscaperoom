...
public class LifeController : MonoBehaviour, IDamageable
{
    ...
    public const string CHARACTER3_GAMEOBJECT_NAME = "CharacterLvl3";
    ...
    public void Die()
    {
        ...
        else if (name == CHARACTER3_GAMEOBJECT_NAME)
        {
            _soundDamageEffectController.OnDamage();
            Invoke("Level3Over", 0.7f);
            return;
        }
    ...
    private void Level3Over()
    {
        EventManager.instance.ActionLvl3Over(false);
        Destroy(this.gameObject);
    }
